...
const OrderManagement: React.FC = () => {
    ...
    const columnsTotalAmountByCustomer = React.useMemo<
        ColumnDef<TotalAmountByCustomer>[]>(
            () => [
                {
                    header: 'שם הלקוח',
        ...
        () => [
...

            {
                ...
                cell: info => {
                    ...
                    return (
                        <>
                            <button onClick={() => setEditingOrder(row)}>
                                ערוך
                            </button>
                            <button onClick={() => deleteOrder(row.orderId)}>
                                מחק
                            </button>
                        </>
                    );
    ...
    return (
        <div>
            <h2>רשימת הזמנות</h2>
            <OrderForm customers={customers} products={products} onAddOrder={addOrder} onUpdateOrder={updateOrder} orders={orders} editingOrder={editingOrder} />
